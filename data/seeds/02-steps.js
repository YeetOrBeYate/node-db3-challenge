...
exports.seed = function(knex) {
  return knex('step').insert([
    ...
    { scheme_id: 2, step_number: 2, instructions: 'find Japanese investors'},
    { scheme_id: 2, step_number: 3, instructions: '????'},
    { scheme_id: 3, step_number: 2, instructions: 'put the flea in a box'},
    { scheme_id: 3, step_number: 4, instructions: 'smash it with a hammer (evil laugh)'},
    { scheme_id: 3, step_number: 1, instructions: 'turn your enemy into a flea'},
    { scheme_id: 3, step_number: 3, instructions: 'mail the box to yourself and when it arrives...'},
    { scheme_id: 4, step_number: 1, instructions: 'write a bot to randomly like posts and follow pages'},
    { scheme_id: 4, step_number: 3, instructions: 'try to ignore the persisent feeling of loneliness and disconnection'},
    ...
    { scheme_id: 5, step_number: 4, instructions: '...and quest some more'},
